...
- **모던 다크 테마**: 눈의 피로를 줄이는 세련된 디자인
- **실시간 점수 표시**: 프로그레스바와 함께 점수 시각화
- **버튼 기반 선택**: 클릭만으로 쉽게 옵션 선택
- **비동기 처리**: UI가 멈추지 않는 부드러운 경험
...
│  📝 프롬프트 입력                                            │
│  ┌─────────────────────────────────────────────────────┐   │
│  │ Python으로 웹 크롤링 코드 작성해줘                     │   │
│  └─────────────────────────────────────────────────────┘   │
│                                          [🚀 분석 시작]     │
├─────────────────────────────────────────────────────────────┤
│  ❓ 크롤링 대상 사이트 유형은 무엇인가요?                     │
│                                                             │
│  ┌──────────────────┐  ┌──────────────────┐                │
│  │ 1. 뉴스/기사      │  │ 2. 쇼핑몰        │                │
│  └──────────────────┘  └──────────────────┘                │
